  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        vata: {
          DEFAULT: "hsl(var(--vata) / <alpha-value>)",
          foreground: "hsl(var(--vata-foreground) / <alpha-value>)",
        },
        pitta: {
          DEFAULT: "hsl(var(--pitta) / <alpha-value>)",
          foreground: "hsl(var(--pitta-foreground) / <alpha-value>)",
        },
        kapha: {
          DEFAULT: "hsl(var(--kapha) / <alpha-value>)",
          foreground: "hsl(var(--kapha-foreground) / <alpha-value>)",
        },
        tier: {
